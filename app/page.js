...
const SAMPLE_PROFESSORS = [
  { id: 1, name: "Prof. Dr. Ahmet Yılmaz", department: "Computer Engineering", courses: ["Data Structures", "Algorithms", "Operating Systems"], avgRating: 4.7, totalReviews: 124, image: null, tags: ["Clear explanations", "Fair exams"] },
  { id: 2, name: "Dr. Elif Demir", department: "Business Administration", courses: ["Marketing Management", "Consumer Behavior", "Brand Strategy"], avgRating: 4.5, totalReviews: 98, image: null, tags: ["Engaging lectures", "Real-world examples"] },
  { id: 3, name: "Prof. Dr. Mehmet Kaya", department: "Law", courses: ["Constitutional Law", "Administrative Law", "Human Rights Law"], avgRating: 4.2, totalReviews: 87, image: null, tags: ["Detailed feedback", "Challenging"] },
  { id: 4, name: "Dr. Zeynep Arslan", department: "Psychology", courses: ["Social Psychology", "Cognitive Psychology", "Research Methods"], avgRating: 4.8, totalReviews: 156, image: null, tags: ["Best professor", "Very helpful"] },
  { id: 5, name: "Assist. Prof. Burak Özdemir", department: "Software Engineering", courses: ["Web Development", "Database Systems", "Software Architecture"], avgRating: 3.9, totalReviews: 72, image: null, tags: ["Lots of projects", "Practical skills"] },
  { id: 6, name: "Prof. Dr. Ayşe Çelik", department: "Architecture", courses: ["Architectural Design", "Urban Planning", "History of Architecture"], avgRating: 4.6, totalReviews: 63, image: null, tags: ["Inspiring", "Creative feedback"] },
  { id: 7, name: "Dr. Ozan Tekin", department: "Economics", courses: ["Microeconomics", "Macroeconomics", "Game Theory"], avgRating: 4.1, totalReviews: 91, image: null, tags: ["Clear grading", "Theoretical focus"] },
  { id: 8, name: "Prof. Dr. Leyla Şahin", department: "Communication", courses: ["Media Studies", "Public Relations", "Journalism"], avgRating: 4.4, totalReviews: 108, image: null, tags: ["Great discussions", "Industry connections"] },
  { id: 9, name: "Dr. Serkan Doğan", department: "International Relations", courses: ["IR Theory", "Foreign Policy", "Diplomacy"], avgRating: 4.3, totalReviews: 77, image: null, tags: ["Current events", "Open discussions"] },
  { id: 10, name: "Assist. Prof. Naz Yıldız", department: "Electrical Engineering", courses: ["Circuit Theory", "Signal Processing", "Electromagnetics"], avgRating: 3.7, totalReviews: 54, image: null, tags: ["Hard grader", "Very knowledgeable"] },
  { id: 11, name: "Prof. Dr. Hakan Eroğlu", department: "Medicine", courses: ["Anatomy", "Physiology", "Biochemistry"], avgRating: 4.5, totalReviews: 142, image: null, tags: ["Thorough", "High standards"] },
  { id: 12, name: "Dr. Pınar Kılıç", department: "Graphic Design", courses: ["Visual Communication", "Typography", "Motion Graphics"], avgRating: 4.9, totalReviews: 89, image: null, tags: ["Highly creative", "Best feedback"] },
];

const SAMPLE_REVIEWS = [
  { id: 1, professorId: 1, rating: 5, teachingQuality: 5, clarity: 5, fairness: 4, difficulty: 4, wouldTakeAgain: true, course: "Data Structures", semester: "Spring 2025", comment: "Professor Yılmaz is outstanding. His explanations are crystal clear and he genuinely cares about student understanding. Office hours are always helpful.", timestamp: "2025-05-12T10:30:00Z" },
  { id: 2, professorId: 1, rating: 4, teachingQuality: 4, clarity: 5, fairness: 4, difficulty: 3, wouldTakeAgain: true, course: "Algorithms", semester: "Fall 2024", comment: "Really good professor. Exams can be tricky but he gives partial credit. Would definitely take his classes again.", timestamp: "2024-12-20T14:20:00Z" },
  { id: 3, professorId: 2, rating: 5, teachingQuality: 5, clarity: 4, fairness: 5, difficulty: 3, wouldTakeAgain: true, course: "Marketing Management", semester: "Spring 2025", comment: "Dr. Demir brings real marketing cases into every lecture. So engaging and you actually learn how marketing works in Turkey and globally.", timestamp: "2025-06-01T09:15:00Z" },
  { id: 4, professorId: 4, rating: 5, teachingQuality: 5, clarity: 5, fairness: 5, difficulty: 3, wouldTakeAgain: true, course: "Social Psychology", semester: "Fall 2024", comment: "Absolutely the best professor at BAU. Dr. Arslan makes every concept relatable and her class is always full. Never missed a single lecture!", timestamp: "2025-01-05T11:00:00Z" },
  { id: 5, professorId: 5, rating: 3, teachingQuality: 3, clarity: 3, fairness: 4, difficulty: 4, wouldTakeAgain: false, course: "Web Development", semester: "Spring 2025", comment: "Projects are good for learning but there are too many of them. Grading criteria could be clearer. Overall a decent class if you put in the work.", timestamp: "2025-05-28T16:40:00Z" },
  { id: 6, professorId: 12, rating: 5, teachingQuality: 5, clarity: 5, fairness: 5, difficulty: 4, wouldTakeAgain: true, course: "Visual Communication", semester: "Spring 2025", comment: "Dr. Kılıç is simply incredible. Her passion for design is contagious and her feedback transforms your work. Best design class I have ever taken.", timestamp: "2025-06-03T08:30:00Z" },
];

const SAMPLE_SUGGESTIONS = [
  { id: 1, name: "Dr. Canan Erdoğan", department: "Psychology", course: "Developmental Psychology", note: "She's a visiting professor but her lectures are amazing, she deserves to be on this platform!", status: "pending", timestamp: "2025-06-10T12:00:00Z", supportCount: 14 },
  { id: 2, name: "Prof. Tarık Baran", department: "Computer Engineering", course: "Machine Learning", note: "New professor this semester, everyone loves his ML course", status: "pending", timestamp: "2025-06-08T09:30:00Z", supportCount: 31 },
  { id: 3, name: "Dr. Selin Aydın", department: "Business Administration", course: "Entrepreneurship", note: "Teaches the startup course, super practical", status: "added", timestamp: "2025-05-30T15:20:00Z", supportCount: 22 },
  { id: 4, name: "Prof. Dr. Kemal Demirtaş", department: "Law", course: "", note: "Commercial Law professor, strict but fair", status: "pending", timestamp: "2025-06-05T11:45:00Z", supportCount: 8 },
];

// Utility functions
function getInitials(name) {
  return name.split(" ").filter(w => /^[A-ZÇĞİÖŞÜ]/.test(w)).slice(-2).map(w => w[0]).join("").toUpperCase();
}
  ...
  return (
    <div style={{ display: "flex", gap: 2 }}>
      {Array.from({ length: max }, (_, i) => {
        ...
        return (
          <svg key={i} width={size} height={size} viewBox="0 0 24 24" fill={filled ? COLORS.gold : COLORS.gray200}
            style={{ cursor: interactive ? "pointer" : "default", transition: "fill 0.15s" }}
            onMouseEnter={interactive ? () => setHover(i + 1) : null}
            onMouseLeave={interactive ? () => setHover(0) : null}
            onClick={interactive ? () => onChange(i + 1) : null}>
...
function ProfessorCard({ professor, onClick }) {
  ...
  return (
    <div onClick={onClick} style={{
      background: COLORS.white, borderRadius: 16, padding: "20px 22px", cursor: "pointer",
      border: `1.5px solid ${COLORS.gray100}`, transition: "all 0.2s ease",
      display: "flex", flexDirection: "column", gap: 14,
    }}
      onMouseEnter={e => { e.currentTarget.style.borderColor = COLORS.navyLight; e.currentTarget.style.boxShadow = "0 8px 32px rgba(10,22,40,0.10)"; e.currentTarget.style.transform = "translateY(-2px)"; }}
      onMouseLeave={e => { e.currentTarget.style.borderColor = COLORS.gray100; e.currentTarget.style.boxShadow = "none"; e.currentTarget.style.transform = "none"; }}>
...
/*function AdPlaceholder({ variant = "banner" }) {
  if (variant === "sidebar") return (
    <div style={{ background: COLORS.gray50, border: `2px dashed ${COLORS.gray200}`, borderRadius: 12, padding: "24px 16px", textAlign: "center", color: COLORS.gray400, fontSize: 12 }}>
      <div style={{ fontSize: 20, marginBottom: 8 }}>📢</div>
      <div style={{ fontWeight: 600, marginBottom: 4 }}>Advertisement</div>
      <div style={{ fontSize: 11 }}>300 × 250</div>
    </div>
  );
  return (
    <div style={{ background: COLORS.gray50, border: `2px dashed ${COLORS.gray200}`, borderRadius: 12, padding: "16px", textAlign: "center", color: COLORS.gray400, fontSize: 12, margin: "16px 0" }}>
      <div style={{ fontWeight: 600, marginBottom: 2 }}>Advertisement</div>
      <div style={{ fontSize: 11 }}>728 × 90 — AdSense Placeholder</div>
    </div>
  );
}
*/
        ...
        <nav style={{ display: "flex", gap: 4, alignItems: "center" }}>
          {navItems.map((item) => (
            <button
              ...
              onMouseEnter={(e) => {
                if (page !== item.id) e.currentTarget.style.color = COLORS.white;
              }}
              onMouseLeave={(e) => {
                if (page !== item.id) e.currentTarget.style.color = COLORS.gray400;
              }}
            >
              {item.label}
            </button>
...
function HomePage({ professors, reviews, setPage, setSelectedProfessor }) {
  ...
  const handleSearch = (val) => {
    setSearch(val);
    if (val.length > 1) {
      setSuggestions(professors.filter(p =>
        p.name.toLowerCase().includes(val.toLowerCase()) || p.department.toLowerCase().includes(val.toLowerCase())
      ).slice(0, 5));
    } else setSuggestions([]);
  };

  const recentReviews = [...reviews].sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp)).slice(0, 3);
        ...
        <div style={{ position: "relative", maxWidth: 700, margin: "0 auto" }}>
          ...
          <div style={{ position: "relative", maxWidth: 520, margin: "0 auto" }}>
            <input
              ...
              onFocus={e => e.currentTarget.style.boxShadow = `0 0 0 3px ${COLORS.gold}44`}
            ...
            {suggestions.length > 0 && (
              <div style={{ position: "absolute", top: "calc(100% + 8px)", left: 0, right: 0, background: COLORS.white, borderRadius: 12, boxShadow: "0 12px 40px rgba(10,22,40,0.18)", zIndex: 50, overflow: "hidden" }}>
                {suggestions.map(p => (
                  <div key={p.id} onClick={() => { setSelectedProfessor(p); setPage("professor"); setSuggestions([]); setSearch(""); }}
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      <span style={{ fontSize: 13, fontWeight: 700, color: COLORS.navy }}>{p.avgRating.toFixed(1)}</span>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 16, marginTop: 28, flexWrap: "wrap" }}>
            <button onClick={() => setPage("professors")} style={{ background: COLORS.red, color: COLORS.white, border: "none", padding: "10px 24px", borderRadius: 10, fontWeight: 700, fontSize: 14, cursor: "pointer", fontFamily: "inherit", transition: "opacity 0.15s" }}
              onMouseEnter={e => e.currentTarget.style.opacity = "0.85"}
              onMouseLeave={e => e.currentTarget.style.opacity = "1"}>
              Browse All Professors
            </button>
            <button onClick={() => setPage("suggestions")} style={{ background: "transparent", color: COLORS.gold, border: `1.5px solid ${COLORS.gold}`, padding: "10px 24px", borderRadius: 10, fontWeight: 700, fontSize: 14, cursor: "pointer", fontFamily: "inherit", transition: "background 0.15s" }}
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {recentReviews.map(r => {
              ...
              return (
                <div key={r.id} style={{ background: COLORS.white, borderRadius: 14, padding: "16px 20px", border: `1px solid ${COLORS.gray100}`, cursor: "pointer" }}
                  onClick={() => { setSelectedProfessor(prof); setPage("professor"); }}
                  onMouseEnter={e => e.currentTarget.style.borderColor = COLORS.navyLight}
                  onMouseLeave={e => e.currentTarget.style.borderColor = COLORS.gray100}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                    <div style={{ flex: 1 }}>
                      ...
                      <p style={{ fontSize: 14, color: COLORS.gray600, margin: 0, lineHeight: 1.5 }}>"{r.comment.slice(0, 120)}..."</p>
                    </div>
...
function ProfessorsPage({ professors, setPage, setSelectedProfessor }) {
  ...
  const filtered = useMemo(() => {
    let list = professors.filter(p => {
      ...
      return (
        (!q || p.name.toLowerCase().includes(q) || p.department.toLowerCase().includes(q) || p.courses.some(c => c.toLowerCase().includes(q))) &&
    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 20px" }}>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 28, flexWrap: "wrap" }}>
        <div style={{ position: "relative", flex: "1 1 220px" }}>
          <input value={search} onChange={e => setSearch(e.target.value)}
            placeholder="Search professor, department, or course..."
            style={{ width: "100%", padding: "10px 16px 10px 40px", borderRadius: 10, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, outline: "none", boxSizing: "border-box", fontFamily: "inherit", color: COLORS.navy }}
            onFocus={e => e.currentTarget.style.borderColor = COLORS.navyLight}
            onBlur={e => e.currentTarget.style.borderColor = COLORS.gray200} />
          <span style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", fontSize: 16 }}>🔍</span>
        </div>
        <select value={dept} onChange={e => setDept(e.target.value)}
          style={{ padding: "10px 16px", borderRadius: 10, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, color: COLORS.navy, background: COLORS.white, fontFamily: "inherit", cursor: "pointer", flex: "1 1 160px" }}>
          <option value="">All Departments</option>
          {DEPARTMENTS.map(d => <option key={d} value={d}>{d}</option>)}
        </select>
        <select value={sort} onChange={e => setSort(e.target.value)}
          style={{ padding: "10px 16px", borderRadius: 10, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, color: COLORS.navy, background: COLORS.white, fontFamily: "inherit", cursor: "pointer", flex: "1 1 140px" }}>
      ...
      {filtered.length === 0 ? (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 16 }}>
          {filtered.map((p, i) => (
            <div key={p.id}>
              <ProfessorCard professor={p} onClick={() => { setSelectedProfessor(p); setPage("professor"); }} />
              {(i + 1) % 6 === 0 && <AdPlaceholder />}
            </div>
          ))}
        </div>
      )}
...
function ReviewForm({ professor, onSubmit, alreadyReviewed }) {
  ...
  const handleSubmit = () => {
    ...
    onSubmit({ ...form, professorId: professor.id, timestamp: new Date().toISOString() });
    setSubmitted(true);
  };
  ...
  return (
    <div style={{ background: COLORS.white, borderRadius: 16, border: `1.5px solid ${COLORS.gray100}`, padding: "24px" }}>
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <input type="range" min={1} max={5} step={1} value={form.difficulty} onChange={e => set("difficulty", +e.target.value)}
          style={{ width: "100%", accentColor: COLORS.navy }} />
        <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, color: COLORS.gray400 }}>
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          {[true, false].map(v => (
            <button key={String(v)} onClick={() => set("wouldTakeAgain", v)} style={{
              padding: "8px 20px", borderRadius: 8, border: `1.5px solid ${form.wouldTakeAgain === v ? (v ? COLORS.success : COLORS.red) : COLORS.gray200}`,
              background: form.wouldTakeAgain === v ? (v ? COLORS.successBg : "#fef2f2") : COLORS.white,
              color: form.wouldTakeAgain === v ? (v ? COLORS.success : COLORS.red) : COLORS.gray600,
              cursor: "pointer", fontWeight: 600, fontSize: 14, fontFamily: "inherit", transition: "all 0.15s",
            }}>{v ? "👍 Yes" : "👎 No"}</button>
          ))}
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
        <div>
          ...
          <input value={form.course} onChange={e => set("course", e.target.value)}
            ...
            style={{ width: "100%", padding: "9px 12px", borderRadius: 8, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, outline: "none", boxSizing: "border-box", fontFamily: "inherit", color: COLORS.navy }} />
        </div>
        <div>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <textarea value={form.comment} onChange={e => set("comment", e.target.value)}
          placeholder="Share your honest experience with this professor. What did you like or dislike? How were the exams and grading? Would you recommend them?"
          rows={4} style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, outline: "none", resize: "vertical", fontFamily: "inherit", color: COLORS.navy, boxSizing: "border-box" }}
          onFocus={e => e.currentTarget.style.borderColor = COLORS.navyLight}
          onBlur={e => e.currentTarget.style.borderColor = COLORS.gray200} />
      ...
      <button onClick={handleSubmit} style={{
        ...
        padding: "13px", borderRadius: 10, fontWeight: 700, fontSize: 15, cursor: "pointer", fontFamily: "inherit", transition: "opacity 0.15s",
      }}
        onMouseEnter={e => e.currentTarget.style.opacity = "0.85"}
        onMouseLeave={e => e.currentTarget.style.opacity = "1"}>
...
<div style={{ marginTop: 12, display: "flex", flexDirection: "column", gap: 6 }}>
  ...
  {professor.faculty && (
    <div style={{ fontSize: 13, color: COLORS.gray600 }}>
      <strong>Faculty:</strong> {professor.faculty}
    </div>
  )}
  ...
  const avgTeaching = profReviews.length ? profReviews.reduce((s, r) => s + (r.teachingQuality || r.rating), 0) / profReviews.length : professor.avgRating;
  const avgClarity = profReviews.length ? profReviews.reduce((s, r) => s + (r.clarity || r.rating), 0) / profReviews.length : professor.avgRating;
  const avgFairness = profReviews.length ? profReviews.reduce((s, r) => s + (r.fairness || r.rating), 0) / profReviews.length : professor.avgRating;
    ...
    {initials}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 24 }}>
              {profReviews.map(r => (
                <div key={r.id} style={{ background: COLORS.white, borderRadius: 14, padding: "20px", border: `1px solid ${COLORS.gray100}` }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                    <div>
                      ...
                      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                        ...
                        {r.wouldTakeAgain !== undefined && r.wouldTakeAgain !== null && (
                          <span style={{ fontSize: 12, borderRadius: 4, padding: "2px 8px", background: r.wouldTakeAgain ? COLORS.successBg : "#fef2f2", color: r.wouldTakeAgain ? COLORS.success : COLORS.red }}>
                  ...
                  <button onClick={() => setReported(p => ({ ...p, [r.id]: true }))}
                    style={{ background: "none", border: "none", color: reported[r.id] ? COLORS.gray400 : COLORS.gray400, cursor: "pointer", fontSize: 12, fontFamily: "inherit", padding: 0 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            {professors.filter(p => p.department === professor.department && p.id !== professor.id).slice(0, 3).map(p => (
              <div key={p.id} style={{ padding: "10px 0", borderBottom: `1px solid ${COLORS.navyLight}`, cursor: "pointer" }}
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 4 }}>
                  <StarRating value={Math.round(p.avgRating)} size={11} />
                  <span style={{ fontSize: 12, color: COLORS.gold }}>{p.avgRating.toFixed(1)}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ background: COLORS.gray50, border: `1.5px solid ${COLORS.gray200}`, borderRadius: 16, padding: "20px" }}>
            <p style={{ fontSize: 13, color: COLORS.gray600, lineHeight: 1.6, margin: "0 0 12px" }}>
              All reviews are anonymous student opinions and do not represent BAU's official position.
            </p>
...
function SuggestionsPage({ suggestions, onAddSuggestion }) {
  ...
  const handleSubmit = () => {
    ...
    if (typeof localStorage !== "undefined" && localStorage.getItem(dupeKey)) {
      setErrors({ name: "You've already suggested this professor from this device." });
      return;
    }

    onAddSuggestion({ ...form, status: "pending", timestamp: new Date().toISOString(), supportCount: 0 });
    if (typeof localStorage !== "undefined") localStorage.setItem(dupeKey, "1");
    setSubmitted(true);
    ...
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 20px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8, flexWrap: "wrap", gap: 16 }}>
        ...
        <button onClick={() => setShowForm(f => !f)} style={{
          background: COLORS.red, color: COLORS.white, border: "none", padding: "11px 22px", borderRadius: 12,
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                <div>
                  ...
                  <input value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))}
                    ...
                    style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: `1.5px solid ${errors.name ? COLORS.red : COLORS.gray200}`, fontSize: 14, outline: "none", boxSizing: "border-box", fontFamily: "inherit", color: COLORS.navy }} />
                ...
                <div>
                  ...
                  <select value={form.department} onChange={e => setForm(f => ({ ...f, department: e.target.value }))}
                    style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: `1.5px solid ${errors.department ? COLORS.red : COLORS.gray200}`, fontSize: 14, background: COLORS.white, color: COLORS.navy, fontFamily: "inherit", cursor: "pointer" }}>
              ...
              <div>
                ...
                <input value={form.course} onChange={e => setForm(f => ({ ...f, course: e.target.value }))}
                  ...
                  style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, outline: "none", boxSizing: "border-box", fontFamily: "inherit", color: COLORS.navy }} />
              </div>
              <div>
                ...
                <textarea value={form.note} onChange={e => setForm(f => ({ ...f, note: e.target.value }))}
                  placeholder="Why should this professor be added? Any context about their courses?"
                  rows={3} style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, outline: "none", resize: "vertical", fontFamily: "inherit", color: COLORS.navy, boxSizing: "border-box" }} />
              </div>
              <div style={{ background: COLORS.gray50, borderRadius: 8, padding: "10px 14px", fontSize: 12, color: COLORS.gray600 }}>
                🔒 Suggestions are completely anonymous.
              </div>
              <button onClick={handleSubmit} style={{
                background: COLORS.navy, color: COLORS.white, border: "none", padding: "12px", borderRadius: 10,
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 20, flexWrap: "wrap" }}>
        <div style={{ position: "relative", flex: "1 1 200px" }}>
          <input value={search} onChange={e => setSearch(e.target.value)}
            ...
            style={{ width: "100%", padding: "9px 14px 9px 36px", borderRadius: 10, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, outline: "none", boxSizing: "border-box", fontFamily: "inherit", color: COLORS.navy }} />
          <span style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", fontSize: 14 }}>🔍</span>
        </div>
        <select value={statusFilter} onChange={e => setStatusFilter(e.target.value)}
          style={{ padding: "9px 14px", borderRadius: 10, border: `1.5px solid ${COLORS.gray200}`, fontSize: 14, color: COLORS.navy, background: COLORS.white, fontFamily: "inherit", cursor: "pointer" }}>
      ...
      {filtered.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          {filtered.map(s => {
            const hasSupported = typeof localStorage !== "undefined" && localStorage.getItem(`ratemybau_support_${s.id}`);
            const count = s.supportCount + (supported[s.id] ? 1 : 0);
            return (
              <div key={s.id} style={{ background: COLORS.white, borderRadius: 16, padding: "20px 22px", border: `1.5px solid ${COLORS.gray100}`, transition: "border-color 0.15s" }}
                onMouseEnter={e => e.currentTarget.style.borderColor = COLORS.gray200}
                onMouseLeave={e => e.currentTarget.style.borderColor = COLORS.gray100}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                  <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, flexShrink: 0 }}>
                    <button
                      ...
                      disabled={hasSupported || supported[s.id]}
                      style={{
                        background: hasSupported || supported[s.id] ? COLORS.successBg : COLORS.gray50,
                        border: `1.5px solid ${hasSupported || supported[s.id] ? COLORS.success : COLORS.gray200}`,
                        color: hasSupported || supported[s.id] ? COLORS.success : COLORS.gray600,
                        borderRadius: 10, padding: "8px 14px", cursor: hasSupported || supported[s.id] ? "default" : "pointer",
                        fontWeight: 700, fontSize: 13, fontFamily: "inherit", transition: "all 0.15s", textAlign: "center",
                      }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 32, marginBottom: 36 }}>
          <div>
            ...
            <p style={{ fontSize: 13, color: COLORS.gray400, lineHeight: 1.7, margin: 0 }}>
              Anonymous student reviews for Bahçeşehir University professors. Helping students make informed decisions.
            </p>
          </div>
          <div>
            ...
            {[["home", "Home"], ["professors", "Professors"], ["suggestions", "Suggest a Professor"]].map(([id, label]) => (
              <div key={id} onClick={() => setPage(id)} style={{ cursor: "pointer", color: COLORS.gray400, fontSize: 13, marginBottom: 8, transition: "color 0.15s" }}
                onMouseEnter={e => e.currentTarget.style.color = COLORS.white}
                onMouseLeave={e => e.currentTarget.style.color = COLORS.gray400}>{label}</div>
            ))}
          </div>
          <div>
         ...
         {[
  		...
  		<div key={item.href} style={{ marginBottom: 8 }}>
    		<Link
      		href={item.href}
      		style={{ color: COLORS.gray400, fontSize: 13, textDecoration: "none" }}
    	>
      		{item.label}
    	    </Link>
  	</div>
          ...
          <div>
            ...
            <p style={{ fontSize: 13, color: COLORS.gray400, lineHeight: 1.7, margin: 0 }}>
              Rate My BAU is an independent student platform. It is not affiliated with or endorsed by Bahçeşehir University.
            </p>
          </div>
        </div>
        <AdPlaceholder />
  ...
  return (
    <div style={{ position: "fixed", bottom: 24, right: 24, zIndex: 200, display: "flex", flexDirection: "column-reverse", alignItems: "flex-end", gap: 10 }}>
      ...
      <button onClick={() => setOpen(o => !o)} style={{
        width: 52, height: 52, borderRadius: "50%", background: COLORS.red, color: COLORS.white, border: "none",
        fontSize: 22, cursor: "pointer", boxShadow: "0 6px 20px rgba(200,16,46,0.40)", transition: "transform 0.2s",
...
export default function Page() {
  ...
  setProfessors((ps) =>
    ps.map((p) => {
      if (p.id !== reviewData.professorId) return p;
      const newTotal = p.totalReviews + 1;
      const newAvg = ((p.avgRating * p.totalReviews) + reviewData.rating) / newTotal;
      return {
        ...p,
  ...
  const currentProfessor = selectedProfessor
    ? professors.find(p => p.id === selectedProfessor.id) || selectedProfessor
    : null;
